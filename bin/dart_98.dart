...
void main() {
  ...
  CustomList list = CustomList([1, 2, 3]);
  list.map((ele) {
    print(ele);
  }).toList();
...
extension type IntId(int id) {
  showId() {
    print(id);
  }
}

// extension type CustomList(List list) {}
// 不继承 Iterable，无法使用 Iterable 的方法
extension type CustomList(List list) implements Iterable {
  removeAll() {
